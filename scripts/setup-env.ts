...
const fields = [
  ...
  },
  {
    ...
    defaultValue: "false",
    help: "Use true only after enabling Message Content Intent in the Discord Developer Portal.",
  },
  {
    key: "SCHEDULED_PROMPTS_USE_AI",
    label: "AI Scheduled Prompts",
    defaultValue: "true",
    help: "Use AI to vary the scheduled 10, 1, and 4 o'clock prompts.",
  },
  {
    key: "ASSISTANT_REPLIES_ENABLED",
    label: "Assistant Replies",
    defaultValue: "true",
    help: "Lets ALP Think answer mentions, direct replies, and contextual prompt responses.",
  },
  {
    key: "ASSISTANT_REPLY_COOLDOWN_SECONDS",
    label: "Assistant Reply Cooldown",
    defaultValue: "20",
    help: "Minimum seconds between ALP Think replies to the same member in the same channel.",
  },
  {
    key: "ASSISTANT_CONTEXTUAL_REPLIES_ENABLED",
    label: "Contextual Replies",
    defaultValue: "true",
    help: "Lets ALP Think answer normal messages that look like responses to recent bot prompts.",
  },
  {
    key: "ASSISTANT_CONTEXTUAL_REPLY_WINDOW_MINUTES",
    label: "Contextual Reply Window",
    defaultValue: "180",
    help: "How long after a morning message, prompt, or recap ALP Think should treat normal messages as possible responses.",
  },
  {
    key: "ASSISTANT_CONTEXTUAL_REPLY_MAX_PER_POST",
    label: "Contextual Reply Limit",
    defaultValue: "3",
    help: "Maximum ALP Think contextual replies per bot post.",
  },
  {
    key: "TARGETED_PROMPT_RESPONSE_HOURS",
    label: "Targeted Prompt Window",
    defaultValue: "24",
    help: "How long ALP Think watches for a member's response after a targeted prompt.",
  },
  {
    key: "OPENAI_MODEL",
    label: "OpenAI Model",
